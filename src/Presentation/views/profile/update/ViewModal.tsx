...
const ProfileUpdateViewModal = (user: User) => {
    ...
    */
    ...
    return {
        ...values, onChange, update, pickImage, onChangeInfoUpdate, errorMessage, user, loading, successMessage
    }
}

export default ProfileUpdateViewModal;