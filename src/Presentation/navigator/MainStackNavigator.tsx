  ...
  return (
    <UserState>
        <Stack.Navigator screenOptions={{ headerShown: false }}>
          ...
          <Stack.Screen name="RolesScreen" component={RolesScreen} options={{ headerShown: true, title: 'Selecciona un rol' }}/>
          ...
          <Stack.Screen name="ProfileUpdateScreen" component={ProfileUpdateScreen} options={{ headerShown: true, title: 'Actualizar Usuario' }}/>
